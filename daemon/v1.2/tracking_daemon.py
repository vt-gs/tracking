...
if __name__ == '__main__':
    ...
    parser.add_option("", "--dish_3m0_ip"  , dest="dish_3m0_ip"  , type="string", default="192.168.42.31" , help=h_3m0_ip)
    parser.add_option("", "--dish_3m0_port", dest="dish_3m0_port", type="int"   , default="2000"          , help=h_3m0_port)
    parser.add_option("", "--dish_4m5_ip"  , dest="dish_4m5_ip"  , type="string", default="192.168.42.41" , help=h_4m5_ip)
    parser.add_option("", "--dish_4m5_port", dest="dish_4m5_port", type="int"   , default="2000"          , help=h_4m5_port)
