            ...
            try:
                if self.connected == False: 
                    ...
                    if self.connected == True:
                        ...
                        self.parent.md01_connect_callback(self.connected) #notify parent of connection
                        time.sleep(1)
                    else:
                        time.sleep(5)
                    ...
                    if self.connected == False:
                        ...
                        self.parent.md01_connect_callback(self.connected) #notify parent of connetion status
                        set_flag = 0
                    else:
